...
public class GuavaObjects {
	...
	public static void main(String args[]) {
		...
		System.out.println(MoreObjects.toStringHelper(s1).add("Name", s1.getFirstName() + " " + s1.getLastName())
...
class Student {
	...
	public boolean equals(Object object) {
		...
		return Objects.equal(firstName, student.firstName) // first name can be null
				...
				&& Objects.equal(rollNo, student.rollNo) && Objects.equal(className, student.className);// class name can be null
	}
